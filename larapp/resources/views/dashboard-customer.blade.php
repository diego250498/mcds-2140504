                    ...
                    <div class="col-md-6 offset-md-3 mt-2">
                        <form method="POST" action="{{ url('customer/'.$user->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $user->name) }}" placeholder="@lang('general.label-name')" autofocus>
                                @error('name')
